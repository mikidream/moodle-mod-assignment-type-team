...
// miki change 	 COALESCE
        ...
        if (($ausers = get_records_sql($select.$sql.$sort, $table->get_page_start(), $table->get_page_size())) !== false) {
            ...
            /// Calculate user status
                ...
                ///Refer to print_student_answer in inherited classes.
                    if ($auser->timemodified > 0) { // after the div ends  it's the add off red mark  in submission list
                ...
                ///Print Comment
					...
					////miki expand the coment box was 30 now 115
        ...
        /// End of fast grading form -miki start
        ...
        /// miki end- Mini form for setting user preference
